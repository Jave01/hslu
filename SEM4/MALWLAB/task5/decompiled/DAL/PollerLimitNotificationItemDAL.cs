...
namespace SolarWinds.Orion.Core.BusinessLayer.DAL
{
  public sealed class PollerLimitNotificationItemDAL : NotificationItemDAL
  {
    ...
    private sealed class EnginesStatus
    {
      ...
      private Dictionary<string, int> WarningEngines => this.warningEngines;

      private Dictionary<string, int> LimitReachedEngines => this.limitReachedEngines;
      ...
      public string Serialize()
      {
        ...
        {
          string.Join("|", this.warningEngines.Select<KeyValuePair<string, int>, string>((Func<KeyValuePair<string, int>, string>) (e => e.Key + ";" + (object) e.Value)).ToArray<string>()),
          string.Join("|", this.limitReachedEngines.Select<KeyValuePair<string, int>, string>((Func<KeyValuePair<string, int>, string>) (e => e.Key + ";" + (object) e.Value)).ToArray<string>())
        });
      }
