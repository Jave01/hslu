...
namespace SolarWinds.Orion.Core.BusinessLayer.DAL
{
  public sealed class MaintenanceExpirationNotificationItemDAL : NotificationItemDAL
  {
    ...
    {
      return !expired ? string.Format(Resources.COREBUSINESSLAYERDAL_CODE_YK0_4, (object) daysToExpire, (object) "http://www.solarwinds.com/embedded_in_products/productLink.aspx?id=online_quote") : string.Format(Resources.COREBUSINESSLAYERDAL_CODE_YK0_3, (object) "http://www.solarwinds.com/embedded_in_products/productLink.aspx?id=online_quote");
    }
    ...
    internal class ExpirationInfo
    {
      ...
      {
        get => this._moduleNameLegacy ?? this.LicenseName;
        set => this._moduleNameLegacy = value;
      }
