...
namespace SolarWinds.Orion.Core.BusinessLayer.DAL
{
  internal static class WebMenubarDAL
  {
    public static int InsertItem(WebMenuItem item)
    {
      ...
      {
        textCommand.Parameters.AddWithValue("title", (object) item.Title);
        textCommand.Parameters.AddWithValue("link", (object) item.Link);
        textCommand.Parameters.AddWithValue("newwindow", item.NewWindow ? (object) "Y" : (object) "N");
        textCommand.Parameters.AddWithValue("description", (object) item.Description);
