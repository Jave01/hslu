...
namespace SolarWinds.Orion.Core.BusinessLayer.DAL
{
  internal sealed class DatabaseLimitNotificationItemDAL : NotificationItemDAL
  {
    ...
    private string WarningTitle = string.Format(Resources.COREBUSINESSLAYERDAL_CODE_1, (object) 80.0) + string.Format(DatabaseLimitNotificationItemDAL.linkWrapper, (object) Resources.COREBUSINESSLAYERDAL_CODE_3, (object) string.Format("http://www.solarwinds.com/documentation/kbloader.aspx?lang={0}&kb=3545", (object) Resources.CurrentHelpLanguage));
    private string LimitReachedTitle = string.Format(Resources.COREBUSINESSLAYERDAL_CODE_2, (object) 90.0) + string.Format(DatabaseLimitNotificationItemDAL.linkWrapper, (object) Resources.COREBUSINESSLAYERDAL_CODE_3, (object) string.Format("http://www.solarwinds.com/documentation/kbloader.aspx?lang={0}&kb=3545", (object) Resources.CurrentHelpLanguage));
    ...
    {
      this.databaseInfoDAL = databaseInfoDAL != null ? databaseInfoDAL : throw new ArgumentNullException(nameof (databaseInfoDAL));
    }
