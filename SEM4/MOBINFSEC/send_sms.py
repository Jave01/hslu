...
phone_number = '0774532654' # ********** change it
...
def power_on(power_key):
    ...
    time.sleep(20)
    ser.flushInput()
    print('SIM8200EA is ready')


def power_down(power_key):
    print('SIM8200EA is loging off:')
    GPIO.output(power_key,GPIO.HIGH)
    time.sleep(3)
    GPIO.output(power_key,GPIO.LOW)
    time.sleep(18)
...
try:
    ...
    print('Please send message from phone ' + phone_number)
    ReceiveShortMessage()
