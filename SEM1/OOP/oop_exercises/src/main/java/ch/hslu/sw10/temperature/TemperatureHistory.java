...
public class TemperatureHistory {
     ...
     * If there is a temperature in the history which .equals() Method returns true,
     * it will be removed.
     * 
     * @param t a Temperature object.
    ...
    /**
     * Returns a concatenation of the string values from each temperature in
     * history.
     * 
     ...
     * Compares the stored max and min value with the new measured max and min
     * values.
     * Calls {@link #fireTemperatureChangeEvent(TemperatureChangeEvent)} if there's
     * a change.
     */
